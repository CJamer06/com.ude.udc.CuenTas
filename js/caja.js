...
function registrarIngreso() {
    ...
    const urlPhp2 = '../php/Caja/guardarSalidas.php';
...
function guardarGastosAcumulados() {
    ...
    const urlPhp3 = '../php/Caja/guardarGastos.php';
...
function cerrarCaja() {
    ...
    const urlPhp4 = '../php/Caja/guardarBalance.php';
    fetch(urlPhp4, {
        method: 'POST',
...
function enviarIngresosPendientes() {
    ...
    const urlPhp5 = '../php/Caja/guardarIngresos.php';
